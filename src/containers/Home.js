          ...
          >
            <Grid item xs={4}>
              ...
              <Typography variant="subheading" align="center">
                Fill up a form and find the storage near by in seconds, or enter
                the zip code to look in the area. Yes is that easy - request,
                store and repeat!
              </Typography>
            </Grid>
            <Grid item xs={4}>
              ...
              <Typography variant="subheading" align="center">
                Having great coverage from our enterprise level scamsurance, you
                can be assured that we got you covered if the things go south!
              </Typography>
            </Grid>
            <Grid item xs={4}>
              <Typography variant="display1" align="center" gutterBottom>
              ...
              <Typography variant="subheading" align="center">
                You don't have to rent entire storage room to hold your favorite
                cup. Now its easy to pack it up in the box, send and you will
